	...
	<form method="POST">
		<div class="enterbox wbox"> 
			...
			<div class="bet">   
            	<div class="box-left">
            	<div class="flex">
            		<div class="box-calender">동행날짜</div>           	
            		<div class="box-calender-d" style="letter-spacing:2px"> ${dto.start_date } ~ ${dto.end_date } </div>	         
				</div>	
               		<!-- 동행게시글 제목, 정원수, 카테고리  -->
	            <div class="flex">
	            ...
	            <div class="flex">  
	                ...
	                <div class="bet">
		                <p>
		                  <input type="submit" class="fsize custom-btn btn-9" value="수정완료" >
		                </p>
	                    <p>
