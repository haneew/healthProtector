...
<div class="frame" style="margin: 100px;" >
    <div class="js-writeFrame">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div>
                <p><input type="text" name="writer" value="${login.userid}" readonly style="border: none;"></p>
                <p>
                ...
                <p>
                    <textarea id="summernote" name="maintext" placeholder="본문을 여기에 작성하세요" required style="width: 500px; height: 300px;"></textarea>
                </p>
